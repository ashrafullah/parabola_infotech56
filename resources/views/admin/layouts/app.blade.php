...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{asset('admin/index.blade.php" class="logo"')}}>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="Brands_list.html"><i class="fa fa-circle-o"></i> Brands List</a></li>
            <li><a href="add_brand.html"><i class="fa fa-circle-o"></i> Add Brand</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="products_list.html"><i class="fa fa-circle-o"></i> Products List</a></li>
            <li><a href="add_products.html"><i class="fa fa-circle-o"></i> Add Products</a></li>
          </ul>
        </li>
